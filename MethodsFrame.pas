...
begin
     ...
     AddRow( 'SFMT'       ,    607, 32,   0, TRandom32SMT607       );
     AddRow( 'SFMT'       ,    607, 64,   0, TRandom64SMT607       );
     AddRow( 'SFMT'       ,   1279, 32,   0, TRandom32SMT1279      );
     AddRow( 'SFMT'       ,   1279, 64,   0, TRandom64SMT1279      );
     AddRow( 'SFMT'       ,   2281, 32,   0, TRandom32SMT2281      );
     AddRow( 'SFMT'       ,   2281, 64,   0, TRandom64SMT2281      );
     AddRow( 'SFMT'       ,   4253, 32,   0, TRandom32SMT4253      );
     AddRow( 'SFMT'       ,   4253, 64,   0, TRandom64SMT4253      );
     AddRow( 'SFMT'       ,  11213, 32,   0, TRandom32SMT11213     );
     AddRow( 'SFMT'       ,  11213, 64,   0, TRandom64SMT11213     );
     AddRow( 'SFMT'       ,  19937, 32,   0, TRandom32SMT19937     );
     AddRow( 'SFMT'       ,  19937, 64,   0, TRandom64SMT19937     );
     AddRow( 'SFMT'       ,  44497, 32,   0, TRandom32SMT44497     );
     AddRow( 'SFMT'       ,  44497, 64,   0, TRandom64SMT44497     );
     AddRow( 'SFMT'       ,  86243, 32,   0, TRandom32SMT86243     );
     AddRow( 'SFMT'       ,  86243, 64,   0, TRandom64SMT86243     );
     AddRow( 'SFMT'       , 132049, 32,   0, TRandom32SMT132049    );
     AddRow( 'SFMT'       , 132049, 64,   0, TRandom64SMT132049    );
     AddRow( 'SFMT'       , 216091, 32,   0, TRandom32SMT216091    );
     AddRow( 'SFMT'       , 216091, 64,   0, TRandom64SMT216091    );
end;
