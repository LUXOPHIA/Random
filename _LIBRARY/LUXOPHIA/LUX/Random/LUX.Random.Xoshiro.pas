...
type //$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$【型】
     ...
     TRandomXOS<_TSeed_:record>     = class;
       ...
       TRandom64XOS<_TSeed_:record> = class;
         TRandom64XOS128            = class;
           ...
           TRandom64XOS128x64       = class;
             TRandom64XOS128x64p    = class;
             TRandom64XOS128x64ss   = class;
     ...
     TRandom64XOS128x64 = class( TRandom64XOS128 )
     private
     protected
       ///// メソッド
       procedure CalcNextSeed; override;
     ...
     TRandom64XOS128x64p = class( TRandom64XOS128x64 )
     private
     protected
       ///// メソッド
       function CalcRandInt64u :Int64u; override;
     ...
     //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% TRandom64XOS128x64ss

     TRandom64XOS128x64ss = class( TRandom64XOS128x64 )
     private
     protected
       ///// メソッド
       function CalcRandInt64u :Int64u; override;
...
procedure TRandom64XOS128x64.CalcNextSeed;
const
...
function TRandom64XOS128x64p.CalcRandInt64u :Int64u;
begin
	   with _Seed do Result := X + Y;
end;
...
function TRandom64XOS128x64ss.CalcRandInt64u :Int64u;
begin
	   Result := Rot( _Seed.X * 5, 7 ) * 9;
end;
